  ...
  for (let i = 0; i < secondaryFotos.length; i += 2) {
    photoPages += `
      <div class="page photo-page">
        ...
        ${secondaryFotos[i + 1] ? `<img class="photo-full" src="${secondaryFotos[i + 1]}" alt="">` : '<div class="photo-full photo-empty"></div>'}
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .photo-empty { background: #F7F8FA; }
  .photo-page .footer { bottom: -8mm; }
</style>
</head>
<body>
